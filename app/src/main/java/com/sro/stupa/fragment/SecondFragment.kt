...
import com.sro.stupa.R
import com.sro.stupa.databinding.FragmentFirstBinding
import com.sro.stupa.databinding.FragmentSecondBinding
...
class SecondFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val userDao: UserDao = Room.databaseBuilder(requireContext(), AppDatabase::class.java, "my_database")
            .build()
            .userDao()
